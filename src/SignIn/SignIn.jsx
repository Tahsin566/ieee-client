...
const SignIn = () => {
  ...
  return (
    <>
      ...
      <section className=" h-[90vh] flex mt-[30px] justify-center p-6">
        <ToastContainer />
            ...
            <div className="bg-white p-6 rounded-lg">
              <div className="space-y-4">
                ...
                {!loading ? <button
                  ...
                  <div>
                    <button onClick={() => navigate('/verify-email')} className='text-center w-full text-blue-600'>Forgot Password</button>
                  </div>
